...
const ProductComponent = ({ product }: PropsProduct) => {
  ...
  return (
    <div
      className="relative max-w-63 overflow-hidden rounded-[15px] transition-all duration-300 hover:-translate-y-1 hover:shadow-xl max-[400px]:w-[90%] cursor-pointer shadow"
